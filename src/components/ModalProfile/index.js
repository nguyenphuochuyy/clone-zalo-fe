...
// Xử lý khi chọn file ảnh
  ...
  return (
    <>
    <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}} onClick={showModal}>
      <UserOutlined style={{fontSize : '16px' , marginRight : '5px'}} ></UserOutlined>
    ...
    >
        ...
        <Upload
              ...
              accept="image/*"
            >
                <div style={{width : 17 , height : 17 , borderRadius : 20 , backgroundColor : '#ddd', display: 'flex' , justifyContent : 'center' , alignItems : 'center',
                    position: 'absolute' ,left : "65px" , top : '110px', cursor : 'pointer', zIndex : 1, padding : 5, border : '1px solid #ddd'
                }}>
      ...
      <div style={{ marginTop: 16, display: 'flex', justifyContent: 'space-between' }}>
          <Button
            type="link"
            icon={<EditOutlined />}
            onClick={() => alert('Chức năng cập nhật thông tin chưa được triển khai!')}
          >
            Cập nhật thông tin
          </Button>
          {file && (
